...
<head>
    ...
    <title>Welcome | Online MCQ Test</title>
...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href="#"><b>Online MCQ Test</b></a>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==1) 
                {
                    ...
                    <tr><td><center><b>S.N.</b></center></td><td><center><b>Subject</b></center></td><td><center><b>Total question</b></center></td><td><center><b>Marks</center></b></td><td><center><b>Action</b></center></td></tr>';
                    $c=1;
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {
						echo '<script>console.log("Welcome to q 2!"); </script>';
                        $q=mysqli_query($con,"SELECT * FROM history WHERE email='$email' ORDER BY date DESC " )or die('Error197');
                        echo  '<div class="panel title">
                        <table class="table table-striped title1" >
                        <tr style="color:black;"><td><center><b>S.N.</b></center></td><td><center><b>Subject</b></center></td><td><center><b>Question Solved</b></center></td><td><center><b>Right</b></center></td><td><center><b>Wrong<b></center></td><td><center><b>Score</b></center></td>';
                        $c=0;
                        while($row=mysqli_fetch_array($q) )
                        {
                        $eid=$row['eid'];
