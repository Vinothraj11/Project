...
<head>
    ...
    <title>Dashboard | Online MCQ Test</title>
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Online MCQ Test</b></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<script>console.log("Welcome to 007th line!"); </script>';
                <ul class="nav navbar-nav navbar-left">
                    <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dashboard.php?q=0">Home<span class="sr-only">(current)</span></a></li>
					<script>console.log("Welcome to 008th line!"); </script>';
                    ...
                    <li><a href="dashboard.php?q=4">Add Subject</a></li>
                    <li><a href="dashboard.php?q=5">Remove Subject</a></li>
                </ul>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    {
                        echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:#fff;"><b>Enter Subject Details</b></span><br /><br />
                ...
                <?php 
                    if(@$_GET['q']==5) 
                    {
                        ...
                        echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
                        <tr><td><center><b>S.N.</b></center></td><td><center><b>Subject</b></center></td><td><center><b>Total question</b></center></td><td><center><b>Marks</b></center></td><td><center><b>Action</b></center></td></tr>';
                        $c=1;
                        while($row = mysqli_fetch_array($result)) {
                            $title = $row['title'];
                            $total = $row['total'];
